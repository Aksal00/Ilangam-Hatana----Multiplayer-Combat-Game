...
class Image_Button:
    ...
    def check_clicked(self):
        ...
        if self.button.collidepoint(pygame.mouse.get_pos()) and pygame.mouse.get_pressed()[0]:
            if current_time - last_click_time > debounce_time:
                ...
                click_sound_fx.play()
                pygame.draw.rect(self.screen, 'red',[self.pos[0], self.pos[1], self.size[0], self.size[1]], 5, 0)
                last_click_time = current_time
                return True
        elif self.button.collidepoint(pygame.mouse.get_pos()):
            pygame.draw.rect(self.screen, 'yellow',[self.pos[0], self.pos[1], self.size[0], self.size[1]], 5, 0)
    ...
    def selected_image_button(self,variable,value):
        if variable == value:
            pygame.draw.rect(self.screen, 'red', [self.pos[0], self.pos[1], self.size[0], self.size[1]], 5, 0)
